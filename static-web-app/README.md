...
This folder contains the React TypeScript front-end application that interacts with the API App Service and showcases the Circuit Breaker Pattern.
...
1. **Configure GitHub Secrets**
   ...
   - `AZURE_STATIC_WEB_APPS_API_TOKEN`: The API token for deploying the Azure Static Web App.
...
- Once deployed, open the Azure Static Web App URL.
- Use the input field and button to interact with the API App Service.
